...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def getitem(self):   ### Edit by Minho 2023.08.26 - No Edit. Training dataset point
            """
            returns:
            ...
            while not valid:
                ...
                if is_video_dataset:
                    ...
                    if self.frame_sample_mode == 'causal':
                        ...
                        while search_frame_ids is None:  ### Edit by Minho 2023.07.06
    ...
    #             search_frame_ids = [1] * self.num_search_frames
    #         try:
    #             template_frames, template_anno, meta_obj_train = dataset.get_frames(seq_id, template_frame_ids[0], seq_info_dict)
    #             search_frames, search_anno, meta_obj_test = dataset.get_frames(seq_id, search_frame_ids[0], seq_info_dict)
