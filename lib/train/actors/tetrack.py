...
class TETrackActor(BaseActor):
    ...
    def forward_pass(self, data):  ### Edit by Minho 2023.08.26
        out_dict, _, _, _ = self.net(data['template_images'][0], data['template_images'][1], data['search_images'])
