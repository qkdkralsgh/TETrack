...
"""
Add default config for TETrack-ViT.
"""
cfg = edict()
...
cfg.MODEL.KEEP_RATIO = [0.617,0.369,0.137]  # [0.75, 0.5, 0.25]
cfg.MODEL.PRUNING_LOC = [3, 7, 11]
# MODEL.BACKBONE
...
cfg.TRAIN.RATIO_WEIGHT = 1.0  # 2.0
cfg.TRAIN.SCORE_WEIGHT = 1.0
cfg.TRAIN.KL_WEIGHT = 1.0
