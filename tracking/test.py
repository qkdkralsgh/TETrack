...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, viz_attn=0, distill=0, 
                threads=0, num_gpus=8, tracker_params=None):
    ...
    run_dataset(dataset, trackers, debug, viz_attn, distill, threads, num_gpus=num_gpus)
...
def main():
    ...
    parser.add_argument('--distill', type=int, default=0, help='Use KD model.')
    ...
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset_name, seq_name, args.debug, args.viz_attn, args.distill,
